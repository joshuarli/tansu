  ...
  try {
    ...
    for (const ts of timestamps) {
      ...
      item.onclick = async () => {
        ...
        pre.style.cssText = 'font-size:12px;max-height:300px;overflow:auto;background:#f6f8fa;padding:8px;border-radius:6px;margin-top:8px;white-space:pre-wrap;word-break:break-word;';
