...
assertContains(
  highlightCode("def foo():", "python"),
  '<span class="hl-kw">def</span>',
  "python keyword",
);
assertContains(
  highlightCode("func main() {}", "go"),
  '<span class="hl-kw">func</span>',
  "go keyword",
);

// Types
assertContains(
  highlightCode('let x: string = ""', "ts"),
...
// Line comments
assertContains(
  highlightCode("// comment", "js"),
  '<span class="hl-cmt">// comment</span>',
  "js line comment",
);
assertContains(
  highlightCode("# comment", "python"),
  '<span class="hl-cmt"># comment</span>',
  "python comment",
);
...
// Block comments
assertContains(
  highlightCode("/* block */", "js"),
  '<span class="hl-cmt">/* block */</span>',
  "js block comment",
);
...
assertContains(
  highlightCode("MAX_SIZE", "js"),
  '<span class="hl-const">MAX_SIZE</span>',
  "constant",
);

// Operators
assertContains(
  highlightCode("a && b", "js"),
...
assertContains(
  multiBlock,
  '<span class="hl-cmt">continued</span>',
  "multiline block comment middle",
);
...
assertContains(
  highlightCode('{"n": 123}', "json"),
  '<span class="hl-num">123</span>',
  "json number",
);
assertContains(
  highlightCode('{"b": true}', "json"),
  '<span class="hl-type">true</span>',
  "json true",
);
assertContains(
  highlightCode('{"b": null}', "json"),
...
// YAML
assertContains(
  highlightCode("key: value # comment", "yaml"),
  '<span class="hl-cmt"># comment</span>',
  "yaml comment",
);
assertContains(
  highlightCode("enabled: true", "yaml"),
  '<span class="hl-type">true</span>',
  "yaml bool",
);
...
// TOML
assertContains(
  highlightCode("# comment", "toml"),
  '<span class="hl-cmt"># comment</span>',
  "toml comment",
);
assertContains(
  highlightCode('key = "value"', "toml"),
...
// Shell aliases
assertContains(
  highlightCode("if true; then echo hi; fi", "sh"),
  '<span class="hl-kw">if</span>',
  "sh keyword",
);
assertContains(
  highlightCode("export FOO=bar", "zsh"),
  '<span class="hl-kw">export</span>',
  "zsh keyword",
);
assertContains(
  highlightCode("export FOO=bar", "shell"),
  '<span class="hl-kw">export</span>',
  "shell keyword",
);
...
assertContains(
  highlightCode("package main", "golang"),
  '<span class="hl-kw">package</span>',
  "golang alias",
);
